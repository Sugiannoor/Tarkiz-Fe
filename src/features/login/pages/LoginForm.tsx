...
const LoginForm = () => { 
  ...
  return (
    ...
    <div className=" lg:flex justify-center items-center">
      ...
      <Typography placeholder={""} className="mt-1 lg:text-lg font-poppins text-custom-gray-600">
        Silahkan Masuk dengan Akun yang sudah ada!
      </Typography>
      <form onSubmit={handleSubmit} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
        <div className="mb-1 flex flex-col gap-6">
          <Typography aria-label="username" placeholder={""} variant="h6" color="blue-gray" className="-mb-3 font-poppins">
            Email
          </Typography>
          <Input crossOrigin={""}
            size="lg"
          ...
          />
          <Typography placeholder={""} variant="h6" color="blue-gray" className="-mb-3 font-poppins">
            Password
          </Typography>
          <Input crossOrigin={""}
            type="password"
        ...
        <Button placeholder={""} color="indigo" className="mt-6 font-body" type="submit" loading={login.isLoading} fullWidth>
         Login
        </Button>
      <Link to={'/'} className="flex gap-1 h-full justify-center mt-2 bg-custom-primary-900 rounded-lg p-[0.50rem] hover:bg-custom-primary-800 duration-300 focus:bg-custom-primary-700">
