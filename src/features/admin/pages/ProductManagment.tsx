  ...
  return (
    <div>
      ...
      <Card placeholder={""} className="w-full h-full p-4">
        ...
        <Button placeholder={""} variant='filled' color='blue-gray' className='flex gap-2' onClick={()=> handleCreateProduct()}>
            <BiPlusCircle size={15}/>
            Tambah Produk
          </Button>
          <Button placeholder={""} variant='filled' color='blue' className='flex gap-2' onClick={()=> handleCreateTag()}>
            <BiPlusCircle size={15}/>
            Tambah Tag Produk
          </Button>
          </div>
