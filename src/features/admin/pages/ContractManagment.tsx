  ...
  return (
    <div>
      ...
      <Breadcrumbs placeholder={""} className='bg-[#005697] px-0'>
       ...
       <a href="/kontrak" className='font-poppins text-white hover:text-gray-300 transition-colors duration-300 ease-in-out'>Manajemen Kontrak</a>
     </Breadcrumbs>
      </div>
      <div className="text-3xl text-white font-poppins font-semibold my-10">Daftar Kontrak</div>
      <Card placeholder={""} className="w-full h-full p-4">
        <div className='flex justify-between'>
          <Button placeholder={""} variant='filled' color='blue' className='flex gap-2' onClick={()=> handleCreateContract()}>
      ...
      <CreateContractModal open={isCreateContracrt} handleOpen={handleCreateContract} />
    </div>
  )
}
