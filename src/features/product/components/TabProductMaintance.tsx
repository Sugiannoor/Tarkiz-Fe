...
import { getAllMaintance, getFinanceMaintance, getMarketingMaintance, getOperationMaintance, getSdmMaintance } from "../api/maintance";
  ...
  export const TabsProductMaintance = () => {
    ...
    const { data: financeMaintance , isLoading: isFinanceLoading } = useQuery<GetProduct>({
      queryKey: ["productFinanceMaintance"],
      queryFn: getFinanceMaintance,
    });
    const { data: operationMaintance , isLoading: isOperationLoading } = useQuery<GetProduct>({
    ...
    const { data: marketingMaintance , isLoading: isMarketingLoading } = useQuery<GetProduct>({
    ...
    const data = [
      ...
      },
      {
        label: "Keuangan",
        value: "finance",
        desc: <AllProduct dataProduct={financeMaintance} isLoading={isFinanceLoading}/>
      },
      {
        label: "Operasional",
        value: "operation",
        desc: <AllProduct dataProduct={operationMaintance} isLoading={isOperationLoading}/>
      },
      {
        label: "SDM",
      ...
      },
      {
        label: "Pemasaran",
        value: "marketing",
        desc: <AllProduct dataProduct={marketingMaintance} isLoading={isMarketingLoading}/>
      },
    ];
