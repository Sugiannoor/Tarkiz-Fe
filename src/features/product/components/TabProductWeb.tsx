...
export const TabsProductWeb = () => {
  const { data: financeWeb, isLoading: isFinanceLoading } =
    useQuery<GetProduct>({
  ...
  const { data: operationWeb, isLoading: isOperationLoading } =
    useQuery<GetProduct>({
      queryKey: ["productOp"],
  ...
  const data = [
    ...
    },
    {
      ...
      value: "finance",
      desc: (
        <AllProduct dataProduct={financeWeb} isLoading={isFinanceLoading} />
      ),
    },
    {
      label: "Operasional",
      value: "operation",
      desc: (
        <AllProduct dataProduct={operationWeb} isLoading={isOperationLoading} />
      ),
    },
    {
      label: "SDM",
    ...
    },
    {
      ...
      value: "marketing",
      desc: (
        <AllProduct dataProduct={marketingWeb} isLoading={isMarketingLoading} />
      ),
    },
  ];
