...
export const TabsProductAndroid = () => {
  ...
  const { data: financeAndroid, isLoading: isFinanceLoading } =
    useQuery<GetProduct>({
      queryKey: ["productFinanceAndroid"],
      queryFn: getFinanceAndroid,
    });
  const { data: operationAndroid, isLoading: isOperationLoading } =
    useQuery<GetProduct>({
  ...
  const { data: marketingAndroid, isLoading: isMarketingLoading } =
    useQuery<GetProduct>({
  ...
  const dataAnroid = [
    ...
    },
    {
      ...
      value: "finance",
      desc: (
        <AllProduct dataProduct={financeAndroid} isLoading={isFinanceLoading} />
      ),
    },
    {
      label: "Operasional",
