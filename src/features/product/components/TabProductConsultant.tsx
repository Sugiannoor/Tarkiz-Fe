...
import { getAllConsultant, getFinanceConsultant, getMarketingConsultant, getOperationConsultant, getSdmConsultant } from "../api/consultant";
...
import { useQuery } from "react-query";
  ...
  export const TabsProductConsultant = () => {
    ...
    const { data: financeConsultant , isLoading: isFinanceLoading } = useQuery<GetProduct>({
      queryKey: ["productFinanceConsultant"],
      queryFn: getFinanceConsultant,
    });
    const { data: operationConsultant , isLoading: isOperationLoading } = useQuery<GetProduct>({
    ...
    const { data: marketingConsultant , isLoading: isMarketingLoading } = useQuery<GetProduct>({
    ...
    const data = [
      ...
      },
      {
        label: "Keuangan",
        value: "finance",
        desc: <AllProduct dataProduct={financeConsultant} isLoading={isFinanceLoading}/>
      },
      {
        label: "Operasional",
        value: "operation",
        desc: <AllProduct dataProduct={operationConsultant} isLoading={isOperationLoading}/>
      },
      {
        label: "SDM",
      ...
      },
      {
        label: "Pemasaran",
        value: "marketing",
        desc: <AllProduct dataProduct={marketingConsultant} isLoading={isMarketingLoading}/>
      },
    ];
